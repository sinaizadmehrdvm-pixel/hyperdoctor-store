      ...
      <div className="mx-auto max-w-7xl px-4 pb-10 pt-12 sm:px-6 sm:pt-14 lg:px-8">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.35fr_.85fr_.85fr_1fr]">
          <div>
            ...
            <div className="mt-6 flex gap-2">{[Camera,BriefcaseBusiness,MessageCircle].map((Icon,index)=><span key={index} className="flex h-10 w-10 items-center justify-center rounded-full border border-white/12 bg-white/7 text-white/70"><Icon className="h-4 w-4"/></span>)}</div>
          </div>
