...
const routeRules: Array<{prefix:string;roles:AdminRole[]}> = [
  ...
  {prefix:"/admin/brands",roles:["SUPER_ADMIN","EDITOR"]},
...
const editorRpc = new Set([
  "admin_add_media","admin_archive_brand","admin_archive_product","admin_archive_service","admin_article_detail","admin_articles_bundle","admin_banners_bundle","admin_brands_search","admin_categories_bundle","admin_categories_search","admin_category_detail","admin_consume_storage_upload_grant","admin_create_storage_upload_grant","admin_delete_article","admin_delete_banner","admin_delete_category","admin_delete_media","admin_delete_page","admin_delete_product_variant","admin_import_product_row","admin_inventory","admin_adjust_stock","admin_media_bundle","admin_media_search","admin_page_detail","admin_pages_bundle","admin_pages_search","admin_product_detail","admin_product_variants","admin_products_bundle","admin_reviews","admin_service_detail","admin_services_bundle","admin_services_search","admin_set_product_brand","admin_update_review","admin_upsert_article","admin_upsert_banner","admin_upsert_brand","admin_upsert_category","admin_upsert_page","admin_upsert_product","admin_upsert_product_variant","admin_upsert_service"
]);
