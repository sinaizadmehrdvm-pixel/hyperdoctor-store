...
async function ensureHooshmand(){return createVerifiedPackBatch(HOOSHMAND_ORDIBEHESHT_1405_SOURCE,HOOSHMAND_ORDIBEHESHT_1405_MASTER,{title:HOOSHMAND_TITLE,pricePolicy:"HISTORICAL",stockPolicy:"IGNORE",priceKind:"CONSUMER",currency:"IRR",notes:"All 41 source-listed records are staged as Draft candidates. Source barcode/identifier is not automatically treated as the Hyper Doctor internal SKU. Prices are historical observations only; current selling price and stock remain zero unless a separate verified current source is applied."})}
